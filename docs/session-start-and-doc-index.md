# Planner - Session Start and Documentation Index

## Purpose

This is the session bootstrap file for Planner.

Every substantial planning, implementation, or review session should begin here.

## Session Start Rule

1. Read this file.
2. Read `.codex/project-skill-config.md`.
3. Read the always-load docs listed below.
4. Read task-relevant docs for the area being touched.
5. Add any new durable planning or architecture doc to this index in the same session it is created.

## Always-Load Docs

### Root instructions

- [AGENTS.md](/home/thetu/planner/AGENTS.md)
- [CLAUDE.md](/home/thetu/planner/CLAUDE.md)
- [.codex/project-skill-config.md](/home/thetu/planner/.codex/project-skill-config.md)
...
### Project-first UI and product flow

- [project-first-ui-research-sessions.md](/home/thetu/planner/docs/project-first-ui-research-sessions.md)
- [phase-00-project-ownership-implementation.md](/home/thetu/planner/docs/phase-00-project-ownership-implementation.md)
- [phase-01-root-landing-implementation.md](/home/thetu/planner/docs/phase-01-root-landing-implementation.md)
- [phase-02-naming-taxonomy-implementation.md](/home/thetu/planner/docs/phase-02-naming-taxonomy-implementation.md)
- [phase-03-component-naming-implementation.md](/home/thetu/planner/docs/phase-03-component-naming-implementation.md)
- [phase-04-knowledge-filter-bar-implementation.md](/home/thetu/planner/docs/phase-04-knowledge-filter-bar-implementation.md)
...
- [socratic-hybrid-question-routing-and-latency-spec.md](/home/thetu/planner/docs/socratic-hybrid-question-routing-and-latency-spec.md)
...
- [planner-solidstart-phase-08-events-timeline-and-snapshots-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-08-events-timeline-and-snapshots-spec.md)
- [planner-solidstart-phase-09-admin-operations-route-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-09-admin-operations-route-spec.md)
- [planner-solidstart-phase-10-knowledge-inventory-route-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-10-knowledge-inventory-route-spec.md)
- [planner-solidstart-phase-11-blueprint-graph-route-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-11-blueprint-graph-route-spec.md)
- [planner-solidstart-phase-12-discovery-triage-route-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-12-discovery-triage-route-spec.md)
- [planner-solidstart-phase-13-route-family-closeout-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-13-route-family-closeout-spec.md)
...
- [planner-solidstart-phase-20-project-surfaces-local-app-and-primitive-hardening-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-20-project-surfaces-local-app-and-primitive-hardening-spec.md)
- [planner-solidstart-phase-21-session-startup-truth-and-status-clarity-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-21-session-startup-truth-and-status-clarity-spec.md)
- [planner-solidstart-phase-22-session-workspace-master-detail-density-and-autosave-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-22-session-workspace-master-detail-density-and-autosave-spec.md)
- [planner-solidstart-phase-23-session-live-artifact-split-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-23-session-live-artifact-split-spec.md)
- [planner-solidstart-phase-24-socratic-runtime-contract-reset-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-24-socratic-runtime-contract-reset-spec.md)
- [planner-solidstart-phase-25-socratic-runtime-verification-hardening-remediation-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-25-socratic-runtime-verification-hardening-remediation-spec.md)
- [planner-solidstart-phase-26-socratic-runtime-truth-completion-remediation-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-26-socratic-runtime-truth-completion-remediation-spec.md)
- [planner-solidstart-phase-27-new-session-startup-truth-remediation-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-27-new-session-startup-truth-remediation-spec.md)
- [planner-solidstart-phase-28-session-entry-and-startup-product-flow-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-28-session-entry-and-startup-product-flow-spec.md)
- [planner-solidstart-phase-29-work-entry-summary-truth-and-workflow-continuity-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-29-work-entry-summary-truth-and-workflow-continuity-spec.md)
- [planner-solidstart-phase-30-project-workspace-route-family-decomposition-spec.md](/home/thetu/planner/docs/planner-solidstart-phase-30-project-workspace-route-family-decomposition-spec.md)
...
- [import-existing-project-phase-1-domain-skeleton-spec.md](/home/thetu/planner/docs/import-existing-project-phase-1-domain-skeleton-spec.md)
- [import-existing-project-phase-2-github-acquisition-spec.md](/home/thetu/planner/docs/import-existing-project-phase-2-github-acquisition-spec.md)
- [import-existing-project-phase-3-analysis-draft-and-socratic-handoff-spec.md](/home/thetu/planner/docs/import-existing-project-phase-3-analysis-draft-and-socratic-handoff-spec.md)
- [import-existing-project-phase-4-review-apply-spec.md](/home/thetu/planner/docs/import-existing-project-phase-4-review-apply-spec.md)
- [import-existing-project-phase-5-local-provider-spec.md](/home/thetu/planner/docs/import-existing-project-phase-5-local-provider-spec.md)
...
- [import-existing-project-phase-10-historical-review-draft-restore-spec.md](/home/thetu/planner/docs/import-existing-project-phase-10-historical-review-draft-restore-spec.md)
...
- [import-existing-project-phase-15-selection-aware-history-comparison-spec.md](/home/thetu/planner/docs/import-existing-project-phase-15-selection-aware-history-comparison-spec.md)
- [import-existing-project-phase-16-history-selection-summary-spec.md](/home/thetu/planner/docs/import-existing-project-phase-16-history-selection-summary-spec.md)
...
- [planner-ui-reset-audit-evidence-closeout-spec.md](/home/thetu/planner/docs/planner-ui-reset-audit-evidence-closeout-spec.md)
- [socratic-session-page-redesign-spec-p1-s1-pulse-bar.md](/home/thetu/planner/docs/socratic-session-page-redesign-spec-p1-s1-pulse-bar.md)
- [socratic-session-page-redesign-spec-p1-s2-focused-canvas.md](/home/thetu/planner/docs/socratic-session-page-redesign-spec-p1-s2-focused-canvas.md)
- [socratic-session-page-redesign-spec-p1-s3-context-shelf.md](/home/thetu/planner/docs/socratic-session-page-redesign-spec-p1-s3-context-shelf.md)
- [socratic-session-page-redesign-spec-p2-s1-question-map.md](/home/thetu/planner/docs/socratic-session-page-redesign-spec-p2-s1-question-map.md)
- [socratic-session-page-redesign-spec-p2-s2-category-visuals.md](/home/thetu/planner/docs/socratic-session-page-redesign-spec-p2-s2-category-visuals.md)
- [socratic-session-page-redesign-spec-p2-s3-dynamic-feedback.md](/home/thetu/planner/docs/socratic-session-page-redesign-spec-p2-s3-dynamic-feedback.md)
- [socratic-session-page-redesign-spec-p3-s1-canvas-states.md](/home/thetu/planner/docs/socratic-session-page-redesign-spec-p3-s1-canvas-states.md)
- [socratic-session-page-redesign-spec-p3-s2-cleanup.md](/home/thetu/planner/docs/socratic-session-page-redesign-spec-p3-s2-cleanup.md)
- [socratic-ethereal-cascade-redesign-spec.md](/home/thetu/planner/docs/socratic-ethereal-cascade-redesign-spec.md)
- [socratic-ethereal-cascade-remediation-spec.md](/home/thetu/planner/docs/socratic-ethereal-cascade-remediation-spec.md)

### Execution checklists and follow-up implementation docs

- [phase-06a-project-archive-execution-checklist.md](/home/thetu/planner/docs/phase-06a-project-archive-execution-checklist.md)
- [phase-06b-pipeline-stop-runtime-execution-checklist.md](/home/thetu/planner/docs/phase-06b-pipeline-stop-runtime-execution-checklist.md)
- [phase-06c-project-delete-cascade-execution-checklist.md](/home/thetu/planner/docs/phase-06c-project-delete-cascade-execution-checklist.md)
- [phase-06d-cxdb-blueprint-delete-execution-checklist.md](/home/thetu/planner/docs/phase-06d-cxdb-blueprint-delete-execution-checklist.md)
- [phase-06e-project-delete-ui-execution-checklist.md](/home/thetu/planner/docs/phase-06e-project-delete-ui-execution-checklist.md)
- [phase-06f-project-lifecycle-hardening-execution-checklist.md](/home/thetu/planner/docs/phase-06f-project-lifecycle-hardening-execution-checklist.md)
- [phase-07-socratic-prompt-protocol-redesign-implementation-prompt.md](/home/thetu/planner/docs/phase-07-socratic-prompt-protocol-redesign-implementation-prompt.md)

### Blueprint research

- [blueprint-research/architecture_tools_research.md](/home/thetu/planner/docs/blueprint-research/architecture_tools_research.md)
- [blueprint-research/BLUEPRINT_DEEP_DIVE.md](/home/thetu/planner/docs/blueprint-research/BLUEPRINT_DEEP_DIVE.md)
- [blueprint-research/DEFERRED_RUST_FEATURES.md](/home/thetu/planner/docs/blueprint-research/DEFERRED_RUST_FEATURES.md)
...
- [builder-phase-c-documented-config-workflow-tightening-spec.md](/home/thetu/planner/docs/builder-phase-c-documented-config-workflow-tightening-spec.md)
- [builder-phase-d-repo-local-dsi-mcp-setup-spec.md](/home/thetu/planner/docs/builder-phase-d-repo-local-dsi-mcp-setup-spec.md)
...
- [USAGE.md](/home/thetu/skills/USAGE.md)
